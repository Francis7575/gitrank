class BadgeService {
  ...
  generateSVG(badgeData) {
    ...
    const rightBgColor =
      colorScheme.rankColors[rank.description] || rank.badge_color;
    ...
    const glowEffect =
      theme === "dark" ? this.createGlowEffect(rightBgColor) : "";
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="${totalWidth}" height="${height}" viewBox="0 0 ${totalWidth} ${height}">
      ...
      <rect x="0" y="0" width="${totalWidth}" height="${height}" 
            ...
            ${
              theme === "dark"
                ? `stroke="${colorScheme.accent}" stroke-width="0.5" opacity="0.8"`
                : ""
            }/>
      ...
      <!-- Right section (rank) -->
      <rect x="${leftWidth + 42}" y="2" width="${rightWidth + 6}" height="${
      height - 4
    }" 
      ...
      <text x="${leftTextX}" y="${textY}" 
            ...
            ${
              theme === "dark" && glowIntensity > 0
                ? `style="text-shadow: 0 0 ${glowIntensity}px rgba(0,255,127,0.3)"`
                : ""
            }>
  ...
  getOctocatSVG(color, height) {
    ...
    return `
      <g transform="translate(8, ${yOffset})">
        <path fill="${color}" d="M${iconSize / 2} 0C${
      (iconSize / 2) * 0.44
    } 0 0 ${(iconSize / 2) * 0.44} 0 ${iconSize / 2}c0 ${
      (iconSize / 2) * 0.44
    } ${(iconSize / 2) * 0.29} ${(iconSize / 2) * 0.81} ${
      (iconSize / 2) * 0.69
    } ${(iconSize / 2) * 0.94}.${(iconSize / 2) * 0.06}.${
      (iconSize / 2) * 0.01
    }.${(iconSize / 2) * 0.07}-.${(iconSize / 2) * 0.03}.${
      (iconSize / 2) * 0.07
    }-.${(iconSize / 2) * 0.06}v-.${(iconSize / 2) * 0.2}c-.${
      (iconSize / 2) * 0.29
    } .${(iconSize / 2) * 0.06}-.${(iconSize / 2) * 0.34}-.${
      (iconSize / 2) * 0.14
    }-.${(iconSize / 2) * 0.34}-.${(iconSize / 2) * 0.14}-.${
      (iconSize / 2) * 0.04
    }-.${(iconSize / 2) * 0.11}-.${(iconSize / 2) * 0.11}-.${
      (iconSize / 2) * 0.14
    }-.${(iconSize / 2) * 0.11}-.${(iconSize / 2) * 0.14}-.${
      (iconSize / 2) * 0.1
    }.${(iconSize / 2) * 0.01}-.${(iconSize / 2) * 0.07}.${
      (iconSize / 2) * 0.01
    }-.${(iconSize / 2) * 0.07}.${(iconSize / 2) * 0.11}.${
      (iconSize / 2) * 0.01
    } ${(iconSize / 2) * 0.17}.${(iconSize / 2) * 0.11} ${
      (iconSize / 2) * 0.17
    }.${(iconSize / 2) * 0.11}.${(iconSize / 2) * 0.1} ${
      (iconSize / 2) * 0.17
    } ${(iconSize / 2) * 0.26}.${(iconSize / 2) * 0.13} ${
      (iconSize / 2) * 0.31
    }.${(iconSize / 2) * 0.1}-.${(iconSize / 2) * 0.03} ${
      (iconSize / 2) * 0.04
    }-.${(iconSize / 2) * 0.13} ${(iconSize / 2) * 0.07}-.${
      (iconSize / 2) * 0.16
    }-${(iconSize / 2) * 0.26}-.${(iconSize / 2) * 0.03}-${
      (iconSize / 2) * 0.51
    }-.${(iconSize / 2) * 0.13}-${(iconSize / 2) * 0.51} 0-.${
      (iconSize / 2) * 0.13
    } ${(iconSize / 2) * 0.04}-.${(iconSize / 2) * 0.23} ${
      (iconSize / 2) * 0.11
    }-.${(iconSize / 2) * 0.31}-.${(iconSize / 2) * 0.01}-.${
      (iconSize / 2) * 0.03
    }-.${(iconSize / 2) * 0.06}-.${(iconSize / 2) * 0.14} .${
      (iconSize / 2) * 0.01
    }-.${(iconSize / 2) * 0.3} 0 0 .${(iconSize / 2) * 0.1}-.${
      (iconSize / 2) * 0.03
    } ${(iconSize / 2) * 0.31}.${(iconSize / 2) * 0.11}.${
      (iconSize / 2) * 0.09
    }-.${(iconSize / 2) * 0.03} ${(iconSize / 2) * 0.19}-.${
      (iconSize / 2) * 0.04
    } ${(iconSize / 2) * 0.29}-.${(iconSize / 2) * 0.04}s.${
      (iconSize / 2) * 0.2
    } .${(iconSize / 2) * 0.01} ${(iconSize / 2) * 0.29} .${
      (iconSize / 2) * 0.04
    }c${(iconSize / 2) * 0.21}-.${(iconSize / 2) * 0.14} ${
      (iconSize / 2) * 0.31
    }-.${(iconSize / 2) * 0.11} ${(iconSize / 2) * 0.31}-.${
      (iconSize / 2) * 0.11
    }.${(iconSize / 2) * 0.07} ${(iconSize / 2) * 0.16} .${
      (iconSize / 2) * 0.03
    } ${(iconSize / 2) * 0.27} .${(iconSize / 2) * 0.01} ${
      (iconSize / 2) * 0.3
    }.${(iconSize / 2) * 0.07}.${(iconSize / 2) * 0.09} .${
      (iconSize / 2) * 0.11
    } ${(iconSize / 2) * 0.19} .${(iconSize / 2) * 0.11} ${
      (iconSize / 2) * 0.31
    } 0 ${(iconSize / 2) * 0.44}-.${(iconSize / 2) * 0.27} ${
      (iconSize / 2) * 0.54
    }-.${(iconSize / 2) * 0.53} ${(iconSize / 2) * 0.57}.${
      (iconSize / 2) * 0.04
    }.${(iconSize / 2) * 0.04} .${(iconSize / 2) * 0.09}.${
      (iconSize / 2) * 0.11
    } .${(iconSize / 2) * 0.09} ${(iconSize / 2) * 0.21}v${
      (iconSize / 2) * 0.31
    }c0 .${(iconSize / 2) * 0.03} .${(iconSize / 2) * 0.01} .${
      (iconSize / 2) * 0.07
    } .${(iconSize / 2) * 0.07} .${(iconSize / 2) * 0.06}C${
      (iconSize / 2) * 1.71
    } ${(iconSize / 2) * 1.81} ${iconSize} ${
      (iconSize / 2) * 1.44
    } ${iconSize} ${iconSize / 2}c0-.${(iconSize / 2) * 0.56}-.${
      (iconSize / 2) * 0.44
    }-${iconSize / 2}-${iconSize / 2}-${iconSize / 2}z"/>
      </g>
    `;
  }
  ...
  generateCompactSVG(badgeData) {
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="${width}" height="${height}" viewBox="0 0 ${width} ${height}">
      ...
      rank.badge_color
    }" rx="${styleConfig.borderRadius}" ry="${styleConfig.borderRadius}"/>
